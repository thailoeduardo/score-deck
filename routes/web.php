...
/**
 * Ver pontos do jogador
 */
Route::get('/room/{id}/point/{point_id}', function ($id, $point_id) {
    // $request->validate([
    //     'user_id' => 'required|exists:users,id',
    //     'points' => 'required|integer|min:0',
    // ], [
...
/**
 * Atualziar ponto do jogador
 */
Route::patch('/room/{room_id}/point/{point_id}', function ($room_id, $point_id, Request $request) {
    $request->validate([
        'user_id' => 'required|exists:users,id',
        'points' => 'required|integer|min:0',
    ], [
...
/**
 * Deletar pontos da sala
 */
Route::delete('/point/{point_id}', function ($room_id, $point_id, Request $request) {
...
})->middleware(['auth', 'verified'])->name('room.delete');
